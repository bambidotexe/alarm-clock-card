 ...
 */}const e="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,i=(t,e,i=null)=>{for(;e!==i;){const i=e.nextSibling;t.removeChild(e),e=i}},n=`{{lit-${String(Math.random()).slice(2)}}}`,s=`\x3c!--${n}--\x3e`,o=new RegExp(`${n}|${s}`);class r{constructor(t,e){this.parts=[],this.element=e;const i=[],s=[],r=document.createTreeWalker(e.content,133,null,!1);let l=0,u=-1,h=0;const{strings:p,values:{length:m}}=t;for(;h<m;){const t=r.nextNode();if(null!==t){if(u++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:i}=e;let n=0;for(let t=0;t<i;t++)a(e[t].name,"$lit$")&&n++;for(;n-- >0;){const e=p[h],i=d.exec(e)[2],n=i.toLowerCase()+"$lit$",s=t.getAttribute(n);t.removeAttribute(n);const r=s.split(o);this.parts.push({type:"attribute",index:u,name:i,strings:r}),h+=r.length-1}}"TEMPLATE"===t.tagName&&(s.push(t),r.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(n)>=0){const n=t.parentNode,s=e.split(o),r=s.length-1;for(let e=0;e<r;e++){let i,o=s[e];if(""===o)i=c();else{const t=d.exec(o);null!==t&&a(t[2],"$lit$")&&(o=o.slice(0,t.index)+t[1]+t[2].slice(0,-"$lit$".length)+t[3]),i=document.createTextNode(o)}n.insertBefore(i,t),this.parts.push({type:"node",index:++u})}""===s[r]?(n.insertBefore(c(),t),i.push(t)):t.data=s[r],h+=r}}else if(8===t.nodeType)if(t.data===n){const e=t.parentNode;null!==t.previousSibling&&u!==l||(u++,e.insertBefore(c(),t)),l=u,this.parts.push({type:"node",index:u}),null===t.nextSibling?t.data="":(i.push(t),u--),h++}else{let e=-1;for(;-1!==(e=t.data.indexOf(n,e+1));)this.parts.push({type:"node",index:-1}),h++}}else r.currentNode=s.pop()}for(const t of i)t.parentNode.removeChild(t)}}const a=(t,e)=>{const i=t.length-e.length;return i>=0&&t.slice(i)===e},l=t=>-1!==t.index,c=()=>document.createComment(""),d=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function u(t,e){const{element:{content:i},parts:n}=t,s=document.createTreeWalker(i,133,null,!1);let o=p(n),r=n[o],a=-1,l=0;const c=[];let d=null;for(;s.nextNode();){a++;const t=s.currentNode;for(t.previousSibling===d&&(d=null),e.has(t)&&(c.push(t),null===d&&(d=t)),null!==d&&l++;void 0!==r&&r.index===a;)r.index=null!==d?-1:r.index-l,o=p(n,o),r=n[o]}c.forEach(t=>t.parentNode.removeChild(t))}const h=t=>{let e=11===t.nodeType?0:1;const i=document.createTreeWalker(t,133,null,!1);for(;i.nextNode();)e++;return e},p=(t,e=-1)=>{for(let i=e+1;i<t.length;i++){const e=t[i];if(l(e))return i}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const b=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:t=>t}),_=` ${n} `;class w{constructor(t,e,i,n){this.strings=t,this.values=e,this.type=i,this.processor=n}getHTML(){const t=this.strings.length-1;let e="",i=!1;for(let o=0;o<t;o++){const t=this.strings[o],r=t.lastIndexOf("\x3c!--");i=(r>-1||i)&&-1===t.indexOf("--\x3e",r+1);const a=d.exec(t);e+=null===a?t+(i?_:s):t.substr(0,a.index)+a[1]+a[2]+"$lit$"+a[3]+n}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");let e=this.getHTML();return void 0!==b&&(e=b.createHTML(e)),t.innerHTML=e,t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,i,n){const s=e[0];if("."===s){return new H(t,e.slice(1),i).parts}if("@"===s)return[new C(t,e.slice(1),n.eventContext)];if("?"===s)return[new E(t,e.slice(1),i)];return new S(t,e,i).parts}handleTextExpression(t){return new $(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.4.0");const it={};class nt extends B{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(Array.isArray(t)){const e=(t,i)=>t.reduceRight((t,i)=>Array.isArray(i)?e(i,t):(t.add(i),t),i),i=e(t,new Set),n=[];i.forEach(t=>n.unshift(t)),this._styles=n}else this._styles=void 0===t?[]:[t];this._styles=this._styles.map(t=>{if(t instanceof CSSStyleSheet&&!Q){const e=Array.prototype.slice.call(t.cssRules).reduce((t,e)=>t+e.cssText,"");return new tt(String(e),X)}return t})}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?Q?this.renderRoot.adoptedStyleSheets=t.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==it&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){return it}}nt.finalized=!0,nt.render=(t,e,n)=>{if(!n||"object"!=typeof n||!n.scopeName)throw new Error("The `scopeName` option is required.");const s=n.scopeName,o=z.has(e),r=U&&11===e.nodeType&&!!e.host,a=r&&!j.has(s),l=a?document.createDocumentFragment():e;if(((t,e,n)=>{let s=z.get(e);void 0===s&&(i(e,e.firstChild),z.set(e,s=new $(Object.assign({templateFactory:D},n))),s.appendInto(e)),s.setValue(t),s.commit()})(t,l,Object.assign({templateFactory:I(s)},n)),a){const t=z.get(l);z.delete(l);const n=t.value instanceof v?t.value.template:void 0;L(s,l,n),i(e,e.firstChild),e.appendChild(l),z.set(e,t)}!o&&r&&window.ShadyCSS.styleElement(e.host)};var st=/d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|Z|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g,ot="[^\\s]+",rt=/\[([^]*?)\]/gm;function at(t,e){for(var i=[],n=0,s=t.length;n<s;n++)i.push(t[n].substr(0,e));return i}var lt=function(t){return function(e,i){var n=i[t].map((function(t){return t.toLowerCase()})).indexOf(e.toLowerCase());return n>-1?n:null}};function ct(t){for(var e=[],i=1;i<arguments.length;i++)e[i-1]=arguments[i];for(var n=0,s=e;n<s.length;n++){var o=s[n];for(var r in o)t[r]=o[r]}return t}var dt=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],ut=["January","February","March","April","May","June","July","August","September","October","November","December"],ht=at(ut,3),pt={dayNamesShort:at(dt,3),dayNames:dt,monthNamesShort:ht,monthNames:ut,amPm:["am","pm"],DoFn:function(t){return t+["th","st","nd","rd"][t%10>3?0:(t-t%10!=10?1:0)*t%10]}},mt=ct({},pt),gt=function(t,e){for(void 0===e&&(e=2),t=String(t);t.length<e;)t="0"+t;return t},ft={D:function(t){return String(t.getDate())},DD:function(t){return gt(t.getDate())},Do:function(t,e){return e.DoFn(t.getDate())},d:function(t){return String(t.getDay())},dd:function(t){return gt(t.getDay())},ddd:function(t,e){return e.dayNamesShort[t.getDay()]},dddd:function(t,e){return e.dayNames[t.getDay()]},M:function(t){return String(t.getMonth()+1)},MM:function(t){return gt(t.getMonth()+1)},MMM:function(t,e){return e.monthNamesShort[t.getMonth()]},MMMM:function(t,e){return e.monthNames[t.getMonth()]},YY:function(t){return gt(String(t.getFullYear()),4).substr(2)},YYYY:function(t){return gt(t.getFullYear(),4)},h:function(t){return String(t.getHours()%12||12)},hh:function(t){return gt(t.getHours()%12||12)},H:function(t){return String(t.getHours())},HH:function(t){return gt(t.getHours())},m:function(t){return String(t.getMinutes())},mm:function(t){return gt(t.getMinutes())},s:function(t){return String(t.getSeconds())},ss:function(t){return gt(t.getSeconds())},S:function(t){return String(Math.round(t.getMilliseconds()/100))},SS:function(t){return gt(Math.round(t.getMilliseconds()/10),2)},SSS:function(t){return gt(t.getMilliseconds(),3)},a:function(t,e){return t.getHours()<12?e.amPm[0]:e.amPm[1]},A:function(t,e){return t.getHours()<12?e.amPm[0].toUpperCase():e.amPm[1].toUpperCase()},ZZ:function(t){var e=t.getTimezoneOffset();return(e>0?"-":"+")+gt(100*Math.floor(Math.abs(e)/60)+Math.abs(e)%60,4)},Z:function(t){var e=t.getTimezoneOffset();return(e>0?"-":"+")+gt(Math.floor(Math.abs(e)/60),2)+":"+gt(Math.abs(e)%60,2)}},yt=function(t){return+t-1},vt=[null,"[1-9]\\d?"],bt=[null,ot],_t=["isPm",ot,function(t,e){var i=t.toLowerCase();return i===e.amPm[0]?0:i===e.amPm[1]?1:null}],wt=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(t){var e=(t+"").match(/([+-]|\d\d)/gi);if(e){var i=60*+e[1]+parseInt(e[2],10);return"+"===e[0]?i:-i}return 0}],xt=(lt("monthNamesShort"),lt("monthNames"),{default:"ddd MMM DD YYYY HH:mm:ss",shortDate:"M/D/YY",mediumDate:"MMM D, YYYY",longDate:"MMMM D, YYYY",fullDate:"dddd, MMMM D, YYYY",isoDate:"YYYY-MM-DD",isoDateTime:"YYYY-MM-DDTHH:mm:ssZ",shortTime:"HH:mm",mediumTime:"HH:mm:ss",longTime:"HH:mm:ss.SSS"});var At=function(t,e,i){if(void 0===e&&(e=xt.default),void 0===i&&(i={}),"number"==typeof t&&(t=new Date(t)),"[object Date]"!==Object.prototype.toString.call(t)||isNaN(t.getTime()))throw new Error("Invalid Date pass to format");var n=[];e=(e=xt[e]||e).replace(rt,(function(t,e){return n.push(e),"@@@"}));var s=ct(ct({},mt),i);return(e=e.replace(st,(function(e){return ft[e](t,s)}))).replace(/@@@/g,(function(){return n.shift()}))};(function(){try{(new Date).toLocaleDateString("i")}catch(t){return"RangeError"===t.name}})(),function(){try{(new Date).toLocaleString("i")}catch(t){return"RangeError"===t.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(t){return"RangeError"===t.name}}();let St=class extends nt{constructor(){super(...arguments),this._initialized=!1}setConfig(t){this._config=t,this.loadCardHelpers()}shouldUpdate(){return this._initialized||this._initialize(),!0}get _name(){var t;return(null===(t=this._config)||void 0===t?void 0:t.name)||""}get _entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.entity)||""}get _alarm_clock_id(){var t;return(null===(t=this._config)||void 0===t?void 0:t.alarm_clock_id)||"alarm_clock"}render(){if(!this.hass||!this._helpers)return O``;const t=Object.keys(this.hass.states).filter(t=>"input_text"===t.substr(0,t.indexOf(".")));return O`
    ...
    `}};t([K({attribute:!1})],St.prototype,"hass",void 0),t([G()],St.prototype,"_config",void 0),t([G()],St.prototype,"_toggle",void 0),t([G()],St.prototype,"_helpers",void 0),St=t([W("alarm-clock-card-editor")],St);var kt={version:"Version",invalid_configuration:"Invalid configuration",show_warning:"Show Warning",show_error:"Show Error"},$t={common:kt},Et={version:"Versjon",invalid_configuration:"Ikke gyldig konfiguration",show_warning:"Vis advarsel"},Ht={common:Et};const Mt={en:Object.freeze({__proto__:null,common:kt,default:$t}),nb:Object.freeze({__proto__:null,common:Et,default:Ht})};function Pt(t,e="",i=""){const n=(localStorage.getItem("selectedLanguage")||"en").replace(/['"]+/g,"").replace("-","_");let s;try{s=t.split(".").reduce((t,e)=>t[e],Mt[n])}catch(e){s=t.split(".").reduce((t,e)=>t[e],Mt.en)}return void 0===s&&(s=t.split(".").reduce((t,e)=>t[e],Mt.en)),""!==e&&""!==i&&(s=s.replace(e,i)),s}
/**
 * @license
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class Ct{constructor(t){this.classes=new Set,this.changed=!1,this.element=t;const e=(t.getAttribute("class")||"").split(/\s+/);for(const t of e)this.classes.add(t)}add(t){this.classes.add(t),this.changed=!0}remove(t){this.classes.delete(t),this.changed=!0}commit(){if(this.changed){let t="";this.classes.forEach(e=>t+=e+" "),this.element.setAttribute("class",t)}}}const Nt=new WeakMap,Dt=(Tt=t=>e=>{if(!(e instanceof k)||e instanceof M||"class"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:i}=e,{element:n}=i;let s=Nt.get(e);void 0===s&&(n.setAttribute("class",i.strings.join(" ")),Nt.set(e,s=new Set));const o=n.classList||new Ct(n);s.forEach(e=>{e in t||(o.remove(e),s.delete(e))});for(const e in t){const i=t[e];i!=s.has(e)&&(i?(o.add(e),s.add(e)):(o.remove(e),s.delete(e)))}"function"==typeof o.commit&&o.commit()},(...t)=>{const e=Tt(...t);return m.set(e,!0),e});var Tt;console.info(`%c  ALARM-CLOCK-CARD \n%c  ${Pt("common.version")} 0.0.1    `,"color: white; font-weight: bold; background: #00EC76","color: #00EC76; font-weight: bold; background: transparent"),window.customCards=window.customCards||[],window.customCards.push({type:"alarm-clock-card",name:"Alarm clock Card",description:"A template custom card for you to create alarm clock"});let zt=class extends nt{constructor(){super(...arguments),this.edit=!1,this.editHour=!0,this.currentAlarmIndex=null,this.currentAlarm=null,this.selectedAlarmIndex=[],this.touchAlarmDuration=500}static async getConfigElement(){return document.createElement("alarm-clock-card-editor")}static getStubConfig(){return{}}setConfig(t){if(!t)throw new Error(Pt("common.invalid_configuration"));const e=t.entity;if(!e||"input_text"!==e.substr(0,e.indexOf(".")))throw new Error(Pt("common.invalid_configuration"));t.test_gui&&function(){var t=document.querySelector("home-assistant");if(t=(t=(t=(t=(t=(t=(t=(t=t&&t.shadowRoot)&&t.querySelector("home-assistant-main"))&&t.shadowRoot)&&t.querySelector("app-drawer-layout partial-panel-resolver"))&&t.shadowRoot||t)&&t.querySelector("ha-panel-lovelace"))&&t.shadowRoot)&&t.querySelector("hui-root")){var e=t.lovelace;return e.current_view=t.___curView,e}return null}().setEditMode(!0),this.config=Object.assign({name:"Alarmes"},t)}shouldUpdate(t){return!!this.config&&function(t,e,i){if(e.has("config")||i)return!0;if(t.config.entity){var n=e.get("hass");return!n||n.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t,!1)}render(){var t,e,i,n,s,o,r,a,l,c,d,u,h,p,m,g,f,y,v,b,_,w,x,A,S,k,$,E,H,M,P,C,N,D,T,z,V,R,U,I,Y,j,L,q,F,J,B,W,Z;if(!this.config.entity)return;const K=this._getAlarms(),G=O`
      ...
      <div class="alarm-clock">
        ...
        <div class="alarm">
          <div class="alarm-datetime"
              @touchstart=${t=>{this._touchAlarmStart(e,t)}}
              @touchend=${t=>{this._touchAlarmEnd(e,t)}}
              @touchmove=${t=>{this._touchAlarmMove(t)}}
              @mousedown=${t=>{this._touchAlarmStart(e,t)}}
              @mouseup=${t=>{this._touchAlarmEnd(e,t)}}
            >
          ...
          <div class="alarm-actions">
            ${this.selectedAlarmIndex.length>0?O`
                <input type="checkbox" .checked=${-1!==this.selectedAlarmIndex.indexOf(e)} @click=${()=>{this._selectAlarm(e)}}>
              `:O`
          ...
          <div class="alarm-detail">
            ...
            <div class="alarm-detail-timepicker">
              <div class="alarm-detail-timepicker-time">
                ...
                <span>:</span>
                <input type="text" maxlength="2" pattern="[0-9]" .value=${((null!==(s=null===(n=this.currentAlarm)||void 0===n?void 0:n.minute)&&void 0!==s?s:0)<10?"0":"")+(null===(o=this.currentAlarm)||void 0===o?void 0:o.minute)} @change=${this._checkAndUpdateEditedAlarmMinute} @click=${()=>{this.editHour=!1}}>
              </div>
              <div class="clock">
                ${this.editHour?O`
                      <div class="clock-hour">
                        <mwc-icon-button hour="12" @click=${()=>{this._updateEditedAlarmHour(12),this.editHour=!1}} class=${Dt({enabled:12==(null===(r=this.currentAlarm)||void 0===r?void 0:r.hour),deg270:!0})}><span style="font-size: 16px; line-height: 26px; ">12</span></mwc-icon-button>
                        <mwc-icon-button hour="1" @click=${()=>{this._updateEditedAlarmHour(1),this.editHour=!1}} class=${Dt({enabled:1==(null===(a=this.currentAlarm)||void 0===a?void 0:a.hour),deg300:!0})}><span style="font-size: 16px; line-height: 26px; ">1</span></mwc-icon-button>
                        <mwc-icon-button hour="2" @click=${()=>{this._updateEditedAlarmHour(2),this.editHour=!1}} class=${Dt({enabled:2==(null===(l=this.currentAlarm)||void 0===l?void 0:l.hour),deg330:!0})}><span style="font-size: 16px; line-height: 26px; ">2</span></mwc-icon-button>
                        <mwc-icon-button hour="3" @click=${()=>{this._updateEditedAlarmHour(3),this.editHour=!1}} class=${Dt({enabled:3==(null===(c=this.currentAlarm)||void 0===c?void 0:c.hour),deg0:!0})}><span style="font-size: 16px; line-height: 26px; ">3</span></mwc-icon-button>
                        <mwc-icon-button hour="4" @click=${()=>{this._updateEditedAlarmHour(4),this.editHour=!1}} class=${Dt({enabled:4==(null===(d=this.currentAlarm)||void 0===d?void 0:d.hour),deg30:!0})}><span style="font-size: 16px; line-height: 26px; ">4</span></mwc-icon-button>
                        <mwc-icon-button hour="5" @click=${()=>{this._updateEditedAlarmHour(5),this.editHour=!1}} class=${Dt({enabled:5==(null===(u=this.currentAlarm)||void 0===u?void 0:u.hour),deg60:!0})}><span style="font-size: 16px; line-height: 26px; ">5</span></mwc-icon-button>
                        <mwc-icon-button hour="6" @click=${()=>{this._updateEditedAlarmHour(6),this.editHour=!1}} class=${Dt({enabled:6==(null===(h=this.currentAlarm)||void 0===h?void 0:h.hour),deg90:!0})}><span style="font-size: 16px; line-height: 26px; ">6</span></mwc-icon-button>
                        <mwc-icon-button hour="7" @click=${()=>{this._updateEditedAlarmHour(7),this.editHour=!1}} class=${Dt({enabled:7==(null===(p=this.currentAlarm)||void 0===p?void 0:p.hour),deg120:!0})}><span style="font-size: 16px; line-height: 26px; ">7</span></mwc-icon-button>
                        <mwc-icon-button hour="8" @click=${()=>{this._updateEditedAlarmHour(8),this.editHour=!1}} class=${Dt({enabled:8==(null===(m=this.currentAlarm)||void 0===m?void 0:m.hour),deg150:!0})}><span style="font-size: 16px; line-height: 26px; ">8</span></mwc-icon-button>
                        <mwc-icon-button hour="9" @click=${()=>{this._updateEditedAlarmHour(9),this.editHour=!1}} class=${Dt({enabled:9==(null===(g=this.currentAlarm)||void 0===g?void 0:g.hour),deg180:!0})}><span style="font-size: 16px; line-height: 26px; ">9</span></mwc-icon-button>
                        <mwc-icon-button hour="10" @click=${()=>{this._updateEditedAlarmHour(10),this.editHour=!1}} class=${Dt({enabled:10==(null===(f=this.currentAlarm)||void 0===f?void 0:f.hour),deg210:!0})}><span style="font-size: 16px; line-height: 26px; ">10</span></mwc-icon-button>
                        <mwc-icon-button hour="11" @click=${()=>{this._updateEditedAlarmHour(11),this.editHour=!1}} class=${Dt({enabled:11==(null===(y=this.currentAlarm)||void 0===y?void 0:y.hour),deg240:!0})}><span style="font-size: 16px; line-height: 26px; ">11</span></mwc-icon-button>

                        <mwc-icon-button hour="0" @click=${()=>{this._updateEditedAlarmHour(0),this.editHour=!1}} class=${Dt({enabled:0==(null===(v=this.currentAlarm)||void 0===v?void 0:v.hour),closeDeg270:!0})}><span style="font-size: 14px; line-height: 24px; ">0</span></mwc-icon-button>
                        <mwc-icon-button hour="13" @click=${()=>{this._updateEditedAlarmHour(13),this.editHour=!1}} class=${Dt({enabled:13==(null===(b=this.currentAlarm)||void 0===b?void 0:b.hour),closeDeg300:!0})}><span style="font-size: 14px; line-height: 24px; ">13</span></mwc-icon-button>
                        <mwc-icon-button hour="14" @click=${()=>{this._updateEditedAlarmHour(14),this.editHour=!1}} class=${Dt({enabled:14==(null===(_=this.currentAlarm)||void 0===_?void 0:_.hour),closeDeg330:!0})}><span style="font-size: 14px; line-height: 24px; ">14</span></mwc-icon-button>
                        <mwc-icon-button hour="15" @click=${()=>{this._updateEditedAlarmHour(15),this.editHour=!1}} class=${Dt({enabled:15==(null===(w=this.currentAlarm)||void 0===w?void 0:w.hour),closeDeg0:!0})}><span style="font-size: 14px; line-height: 24px; ">15</span></mwc-icon-button>
                        <mwc-icon-button hour="16" @click=${()=>{this._updateEditedAlarmHour(16),this.editHour=!1}} class=${Dt({enabled:16==(null===(x=this.currentAlarm)||void 0===x?void 0:x.hour),closeDeg30:!0})}><span style="font-size: 14px; line-height: 24px; ">16</span></mwc-icon-button>
                        <mwc-icon-button hour="17" @click=${()=>{this._updateEditedAlarmHour(17),this.editHour=!1}} class=${Dt({enabled:17==(null===(A=this.currentAlarm)||void 0===A?void 0:A.hour),closeDeg60:!0})}><span style="font-size: 14px; line-height: 24px; ">17</span></mwc-icon-button>
                        <mwc-icon-button hour="18" @click=${()=>{this._updateEditedAlarmHour(18),this.editHour=!1}} class=${Dt({enabled:18==(null===(S=this.currentAlarm)||void 0===S?void 0:S.hour),closeDeg90:!0})}><span style="font-size: 14px; line-height: 24px; ">18</span></mwc-icon-button>
                        <mwc-icon-button hour="19" @click=${()=>{this._updateEditedAlarmHour(19),this.editHour=!1}} class=${Dt({enabled:19==(null===(k=this.currentAlarm)||void 0===k?void 0:k.hour),closeDeg120:!0})}><span style="font-size: 14px; line-height: 24px; ">19</span></mwc-icon-button>
                        <mwc-icon-button hour="20" @click=${()=>{this._updateEditedAlarmHour(20),this.editHour=!1}} class=${Dt({enabled:20==(null===($=this.currentAlarm)||void 0===$?void 0:$.hour),closeDeg150:!0})}><span style="font-size: 14px; line-height: 24px; ">20</span></mwc-icon-button>
                        <mwc-icon-button hour="21" @click=${()=>{this._updateEditedAlarmHour(21),this.editHour=!1}} class=${Dt({enabled:21==(null===(E=this.currentAlarm)||void 0===E?void 0:E.hour),closeDeg180:!0})}><span style="font-size: 14px; line-height: 24px; ">21</span></mwc-icon-button>
                        <mwc-icon-button hour="22" @click=${()=>{this._updateEditedAlarmHour(22),this.editHour=!1}} class=${Dt({enabled:22==(null===(H=this.currentAlarm)||void 0===H?void 0:H.hour),closeDeg210:!0})}><span style="font-size: 14px; line-height: 24px; ">22</span></mwc-icon-button>
                        <mwc-icon-button hour="23" @click=${()=>{this._updateEditedAlarmHour(23),this.editHour=!1}} class=${Dt({enabled:23==(null===(M=this.currentAlarm)||void 0===M?void 0:M.hour),closeDeg240:!0})}><span style="font-size: 14px; line-height: 24px; ">23</span></mwc-icon-button>
                      </div>
                    `:O`
                      <div class="clock-minute">
                        <mwc-icon-button minute="0" @click=${()=>{this._updateEditedAlarmMinute(0)}} class=${Dt({enabled:0==(null===(P=this.currentAlarm)||void 0===P?void 0:P.minute),deg270:!0})}><span style="font-size: 16px; line-height: 26px; ">0</span></mwc-icon-button>
                        <mwc-icon-button minute="5" @click=${()=>{this._updateEditedAlarmMinute(5)}} class=${Dt({enabled:5==(null===(C=this.currentAlarm)||void 0===C?void 0:C.minute),deg300:!0})}><span style="font-size: 16px; line-height: 26px; ">5</span></mwc-icon-button>
                        <mwc-icon-button minute="10" @click=${()=>{this._updateEditedAlarmMinute(10)}} class=${Dt({enabled:10==(null===(N=this.currentAlarm)||void 0===N?void 0:N.minute),deg330:!0})}><span style="font-size: 16px; line-height: 26px; ">10</span></mwc-icon-button>
                        <mwc-icon-button minute="15" @click=${()=>{this._updateEditedAlarmMinute(15)}} class=${Dt({enabled:15==(null===(D=this.currentAlarm)||void 0===D?void 0:D.minute),deg0:!0})}><span style="font-size: 16px; line-height: 26px; ">15</span></mwc-icon-button>
                        <mwc-icon-button minute="20" @click=${()=>{this._updateEditedAlarmMinute(20)}} class=${Dt({enabled:20==(null===(T=this.currentAlarm)||void 0===T?void 0:T.minute),deg30:!0})}><span style="font-size: 16px; line-height: 26px; ">20</span></mwc-icon-button>
                        <mwc-icon-button minute="25" @click=${()=>{this._updateEditedAlarmMinute(25)}} class=${Dt({enabled:25==(null===(z=this.currentAlarm)||void 0===z?void 0:z.minute),deg60:!0})}><span style="font-size: 16px; line-height: 26px; ">25</span></mwc-icon-button>
                        <mwc-icon-button minute="30" @click=${()=>{this._updateEditedAlarmMinute(30)}} class=${Dt({enabled:30==(null===(V=this.currentAlarm)||void 0===V?void 0:V.minute),deg90:!0})}><span style="font-size: 16px; line-height: 26px; ">30</span></mwc-icon-button>
                        <mwc-icon-button minute="35" @click=${()=>{this._updateEditedAlarmMinute(35)}} class=${Dt({enabled:35==(null===(R=this.currentAlarm)||void 0===R?void 0:R.minute),deg120:!0})}><span style="font-size: 16px; line-height: 26px; ">35</span></mwc-icon-button>
                        <mwc-icon-button minute="40" @click=${()=>{this._updateEditedAlarmMinute(40)}} class=${Dt({enabled:40==(null===(U=this.currentAlarm)||void 0===U?void 0:U.minute),deg150:!0})}><span style="font-size: 16px; line-height: 26px; ">40</span></mwc-icon-button>
                        <mwc-icon-button minute="45" @click=${()=>{this._updateEditedAlarmMinute(45)}} class=${Dt({enabled:45==(null===(I=this.currentAlarm)||void 0===I?void 0:I.minute),deg180:!0})}><span style="font-size: 16px; line-height: 26px; ">45</span></mwc-icon-button>
                        <mwc-icon-button minute="50" @click=${()=>{this._updateEditedAlarmMinute(50)}} class=${Dt({enabled:50==(null===(Y=this.currentAlarm)||void 0===Y?void 0:Y.minute),deg210:!0})}><span style="font-size: 16px; line-height: 26px; ">50</span></mwc-icon-button>
                        <mwc-icon-button minute="55" @click=${()=>{this._updateEditedAlarmMinute(55)}} class=${Dt({enabled:55==(null===(j=this.currentAlarm)||void 0===j?void 0:j.minute),deg240:!0})}><span style="font-size: 16px; line-height: 26px; ">55</span></mwc-icon-button>
                      </div>
                    `}
              </div>
            </div>
            ...
            <div class="alarm-detail-repeat">
              <mwc-icon-button @click=${()=>{this._updateEditedAlarmEabledDay(0)}} class=${Dt({enabled:!!(null===(L=this.currentAlarm)||void 0===L?void 0:L.monday)})}>
                <span style="font-size: 16px; line-height: 26px; ">L</span>
              </mwc-icon-button>
              <mwc-icon-button @click=${()=>{this._updateEditedAlarmEabledDay(1)}} class=${Dt({enabled:!!(null===(q=this.currentAlarm)||void 0===q?void 0:q.tuesday)})}>
                <span style="font-size: 16px; line-height: 26px;">M</span>
              </mwc-icon-button>
              <mwc-icon-button @click=${()=>{this._updateEditedAlarmEabledDay(2)}} class=${Dt({enabled:!!(null===(F=this.currentAlarm)||void 0===F?void 0:F.wednesday)})}>
                <span style="font-size: 16px; line-height: 26px;">M</span>
              </mwc-icon-button>
              <mwc-icon-button @click=${()=>{this._updateEditedAlarmEabledDay(3)}} class=${Dt({enabled:!!(null===(J=this.currentAlarm)||void 0===J?void 0:J.thursday)})}>
                <span style="font-size: 16px; line-height: 26px;">J</span>
              </mwc-icon-button>
              <mwc-icon-button @click=${()=>{this._updateEditedAlarmEabledDay(4)}} class=${Dt({enabled:!!(null===(B=this.currentAlarm)||void 0===B?void 0:B.friday)})}>
                <span style="font-size: 16px; line-height: 26px;">V</span>
              </mwc-icon-button>
              <mwc-icon-button @click=${()=>{this._updateEditedAlarmEabledDay(5)}} class=${Dt({enabled:!!(null===(W=this.currentAlarm)||void 0===W?void 0:W.saturday)})}>
                <span style="font-size: 16px; line-height: 26px;">S</span>
              </mwc-icon-button>
              <mwc-icon-button @click=${()=>{this._updateEditedAlarmEabledDay(6)}} class=${Dt({enabled:!!(null===(Z=this.currentAlarm)||void 0===Z?void 0:Z.sunday)})}>
    ...
    `}};t([K({attribute:!1})],zt.prototype,"hass",void 0),t([K({attribute:!1})],zt.prototype,"edit",void 0),t([K({attribute:!1})],zt.prototype,"editHour",void 0),t([K({attribute:!1})],zt.prototype,"currentAlarmIndex",void 0),t([K({attribute:!1})],zt.prototype,"currentAlarm",void 0),t([K({attribute:!1})],zt.prototype,"selectedAlarmIndex",void 0),t([G()],zt.prototype,"config",void 0),t([K({attribute:!1})],zt.prototype,"touchAlarmTimer",void 0),t([K({attribute:!1})],zt.prototype,"touchAlarmDuration",void 0),zt=t([W("alarm-clock-card")],zt);export{zt as AlarmClockCard};
