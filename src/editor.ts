...
import { AlarmClockCardConfig } from './types';
...
export class AlarmClockCardEditor extends LitElement implements LovelaceCardEditor {
  ...
  @internalProperty() private _config?: AlarmClockCardConfig;
  ...
  get _alarm_clock_id(): string {
    return this._config?.alarm_clock_id || 'alarm_clock';
  }
