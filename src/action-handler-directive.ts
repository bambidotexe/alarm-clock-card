...
customElements.define('action-handler-alarm-clock', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-alarm-clock')) {
    return body.querySelector('action-handler-alarm-clock') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-alarm-clock');
